...
// TODO: Nuke this when Compose MD3 1.6.0 stable is released
...
private fun FloatingActionButtonMenuItemColumn(
    ...
    var staggerAnimSpec: FiniteAnimationSpec<Int> = spring(dampingRatio = 1f, stiffness = 800.0f)
...
fun FloatingActionButtonMenuScope.FloatingActionButtonMenuItem(
    ...
    val widthSpring: FiniteAnimationSpec<Float> = spring(dampingRatio = 0.6f, stiffness = 800.0f)
    val alphaSpring: FiniteAnimationSpec<Float> = spring(dampingRatio = 1f, stiffness = 3800.0f)
    val coroutineScope = rememberCoroutineScope()
    ...
    // CompositionLocalProvider(LocalMinimumInteractiveComponentSize provides 0.dp) {
        Surface(
            ...
            shape = FabMenuBaselineTokens.ListItemContainerShape,
...
fun ToggleFloatingActionButton(
    ...
    val checkedProgress =
        animateFloatAsState(
            ...
            animationSpec = spring(dampingRatio = 0.6f, stiffness = 800.0f),
        )
...
private object FabBaselineTokens {
    val ContainerHeight = 56.0.dp
    val ContainerShape = ShapeDefaults.Large
    val ContainerWidth = 56.0.dp
    val IconSize = 24.0.dp
}

private object FabMediumTokens {
...
private object FabLargeTokens {
    val ContainerHeight = 96.0.dp
    val ContainerShape = ShapeDefaults.ExtraLarge
    val ContainerWidth = 96.0.dp
    val IconSize = 32.0.dp
}

private object FabMenuBaselineTokens {
    ...
    val ListItemContainerShape = CircleShape
