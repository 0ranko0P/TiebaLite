...
val GitHubInvertocat: ImageVector
    get() {
        if (_GitHubInvertocat != null) {
            return _GitHubInvertocat!!
        }
        _GitHubInvertocat = ImageVector.Builder(
            name = "GitHubInvertocat",
...
private var _GitHubInvertocat: ImageVector? = null
